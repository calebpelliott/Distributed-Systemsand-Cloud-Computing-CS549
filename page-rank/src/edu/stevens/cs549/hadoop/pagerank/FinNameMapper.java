...
public class FinNameMapper extends Mapper<LongWritable, Text, DoubleWritable, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		String currentWeight = sections[1];
		currentWeight = currentWeight.replace("[", "");
		currentWeight = currentWeight.replace("]", "");
		
		context.write(new DoubleWritable(Double.parseDouble(currentWeight)), new Text(nodeName));
